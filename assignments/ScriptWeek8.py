...
# DB: I found this on a branch in your fork of the week 8 repository, but didn't see a pull request.
#     Really good! Seems to work well. My only suggestions are to put some more empty lines to break
#     up different logical parts of the code, and to add a few more specific comments about lines
#     that might require explanation (often, if statements and for loops).